...
const mockAgreementsToRedact = [
  { reference: 'FAKE-REF-1', redactedSbi: '103592529' },
  { reference: 'FAKE-REF-2', redactedSbi: '145592529' }
]
...
describe('redact-pii', () => {
  ...
  describe('POST /api/redact/pii', () => {
    test('should return OK status when called with agreementsToRedact in payload', async () => {
      ...
      expect(redactPII).toHaveBeenCalledWith('FAKE-REF-1', '103592529', expect.any(Object))
      expect(redactPII).toHaveBeenCalledWith('FAKE-REF-2', '145592529', expect.any(Object))
